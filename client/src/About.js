...
const About = () => {
  ...
  const AboutFunction = async () => {
    try {
      const response = await fetch("https://bhai-saini-flipkart-backend-app.onrender.com/about", {
        method: "get",
        headers: {
...
console.log(data)
  ...
  const sendData = async () => {
    ...
    try {
      const response = await fetch("https://bhai-saini-flipkart-backend-app.onrender.com/changeData", {
        method: "put",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const sendImage = async () => {
    ...
    try {
      const response = await fetch("https://bhai-saini-flipkart-backend-app.onrender.com/profile", {
        method: "put",
        body: formData,
  ...
  const deleteAccountFunction = async () => {
    try {
      const response = await fetch("https://bhai-saini-flipkart-backend-app.onrender.com/deleteAccount", {
        method: "delete",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
