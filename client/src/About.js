...
const About = () => {
  ...
  const AboutFunction = async () => {
    try {
      const response = await fetch("https://flipkart-saini-back.onrender.com/about", {
        method: "get",
        headers: {
...
console.log(data)
  ...
  const sendData = async () => {
    ...
    try {
      const response = await fetch("https://flipkart-saini-back.onrender.com/changeData", {
        method: "put",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const sendImage = async () => {
    ...
    try {
      const response = await fetch("https://flipkart-saini-back.onrender.com/profile", {
        method: "put",
        body: formData,
        credentials:"include"
      })
  ...
  const myLogout = async () => {
    try {
      const response = await fetch("https://flipkart-saini-back.onrender.com/logout", {
        method: "get",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  const deleteAccountFunction = async () => {
    try {
      const response = await fetch("https://flipkart-saini-back.onrender.com/deleteAccount", {
        method: "delete",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
