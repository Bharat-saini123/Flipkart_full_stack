              ...
              return (
                <div key={currData.id}>
                  <div className="all-images main-image-hover-effect" >
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"1rem",height:"50rem",marginLeft:"3rem",overflowY:"scroll"}}>
